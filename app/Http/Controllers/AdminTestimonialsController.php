<?php namespace App\Http\Controllers;
	...
	class AdminTestimonialsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Designation','name'=>'designation','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-7'];
			$this->form[] = ['label'=>'Comment','name'=>'comment','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-7'];
