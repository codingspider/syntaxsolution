<?php namespace App\Http\Controllers;
	...
	class AdminTeamsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Linkedin','name'=>'linkedin','type'=>'text','width'=>'col-sm-10'];
